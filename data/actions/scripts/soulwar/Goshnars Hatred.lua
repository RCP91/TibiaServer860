...
local function clearHatredRoom()
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 and item.actionid == 30055 then -- ID da alavanca OU QUALQUER ITEM, e em seguida ACTION ID que está na alavanca.
