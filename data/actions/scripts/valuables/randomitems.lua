local config = {
	...
	[25419] = { -- shaggy ogre bag
		...
		chances = {
			{from = 1, to = 2},
			{from = 3, to = 2167, itemId = 17101, count = 5},
			{from = 2168, to = 4243, itemId = 17101, count = 5},
			{from = 4244, to = 6196, itemId = 17101, count = 5},
			{from = 6197, to = 8149, itemId = 17101, count = 5},
			{from = 8150, to = 9823, itemId = 17101, count = 5},
			{from = 9824, to = 9923, itemId = 17101, count = 5},
			{from = 9924, to = 9990, itemId = 17101, count = 5},
			{from = 9991, to = 10001, itemId = 17101, count = 5},
		},
		effect = CONST_ME_CRAPS
	},
