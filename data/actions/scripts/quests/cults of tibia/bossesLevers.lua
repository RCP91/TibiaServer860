...
local function spawnStolenSoul(t_time)
	...
	addEvent(spawnStolenSoul, 100, t_time - 1)
end

local function spawnDarkSoul(area, t_time)
	if t_time == 0 then
		local esperandoPlayer = false
		local p1 = Position(33032, 31917, 15)
		local p2 = Position(33046, 31917, 15)
		local sA1 = Position(33035, 31916, 15)
		local sA2 = Position(33049, 31927, 15)
		if area == 2 then
			p1 = Position(33032, 31917, 15)
			p2 = Position(33037, 31920, 15)
			sA1 = Position(33035, 31916, 15)
			sA2 = Position(33049, 31927, 15)
		end
...
function onUse(player, item, fromPosition, itemEx, toPosition)
	...
	if item:getActionId() == 5506 then
		if player:getPosition() == Position(33074, 31884, 15) and item:getId() == 9826 then
			...
			Game.createMonster('Dark Soul', Position(33039, 31919, 15))
			spawnDarkSoul(1, 30)
			spawnDarkSoul(2, 30)
			spawnStolenSoul(30)
