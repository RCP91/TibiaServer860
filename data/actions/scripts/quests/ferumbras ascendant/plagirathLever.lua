...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	for i = 1, #spectators do
		...
		Game.getStorageValue(GlobalStorage.FerumbrasAscendantQuest.PlagirathTimer, 1)
		addEvent(clearForgotten, 30 * 60 * 1000, Position(33159, 31491, 13), Position(33185, 31513, 13), Position(33319, 32318, 13), GlobalStorage.FerumbrasAscendantQuest.PlagirathTimer)
		item:transform(9826)
