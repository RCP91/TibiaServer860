...
local potions = {
	...
	[26029] = {mana = {425, 575}, vocations = {1, 2, 5, 6}, level = 300, flask = 7635,
			description = "Only druids and sorcerers of level 130 or above may drink this fluid."},

	[26030] = {health = {420, 580}, mana = {250, 350}, vocations = {3, 7}, level = 300, flask = 7635,
			description = "Only paladins of level 130 or above may drink this fluid."},

	[26031] = {health = {875, 1125}, vocations = {4, 8}, level = 300, flask = 7635,
