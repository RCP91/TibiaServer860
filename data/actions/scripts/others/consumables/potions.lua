...
local potions = {
	...
	[7588] = {health = {250, 350}, vocations = {3, 4, 7, 8}, level = 50, 
			description = "Only knights and paladins of level 50 or above may drink this fluid."},

	[7589] = {mana = {115, 185}, vocations = {1, 2, 3, 5, 6, 7}, level = 50, 
			description = "Only sorcerers, druids and paladins of level 50 or above may drink this fluid."},

	[7590] = {mana = {150, 250}, vocations = {1, 2, 5, 6}, level = 80, 
			description = "Only druids and sorcerers of level 80 or above may drink this fluid."},

	[7591] = {health = {425, 575}, vocations = {4, 8}, level = 80, 
			description = "Only knights of level 80 or above may drink this fluid."},

	[7618] = {health = {125, 175}},
	[7620] = {mana = {75, 125}},
	[8472] = {health = {250, 350}, mana = {100, 200}, vocations = {3, 7}, level = 80, 
			description = "Only paladins of level 80 or above may drink this fluid."},

	[8473] = {health = {650, 850}, vocations = {4, 8}, level = 130, 
			description = "Only knights of level 130 or above may drink this fluid."},

	[8474] = {combat = antidote},
	[8704] = {health = {60, 90}},
	[26029] = {mana = {425, 575}, vocations = {1, 2, 5, 6}, level = 300, 
			description = "Only druids and sorcerers of level 300 or above may drink this fluid."},

	[26030] = {health = {420, 580}, mana = {250, 350}, vocations = {3, 7}, level = 300,
			description = "Only paladins of level 300 or above may drink this fluid."},

	[26031] = {health = {875, 1125}, vocations = {4, 8}, level = 300,
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if (player:getStorageValue(STORAGE_PLAYER_IN_ARENA) == 1 and player:getStorageValue(STORAGE_POTION) == 1) then
	if isInArray({26030, 26031, 26029}, item:getId()) then
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You cannot use this potion inside the Anti Entrosa.")
		return true
	end
end
