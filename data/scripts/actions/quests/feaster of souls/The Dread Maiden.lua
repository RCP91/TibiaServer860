local config = {
	...
	bossName2 = "Green Soul Stealer",
	bossName3 = "Green Soul Stealer",
	bossName4 = "Green Soul Stealer",
	bossName5 = "Green Soul Stealer",
	bossName6 = "Red Soul Stealer",
	bossName7 = "Red Soul Stealer",
	bossName8 = "Red Soul Stealer",
	summonName = "Rift Invader",
	bossPos = Position{x = 33713, y = 31501, z = 14},
	horror = Position{x = 33710, y = 31502, z = 14},
	phobia = Position{x = 33717, y = 31503, z = 14},
	fear = Position{x = 33707, y = 31506, z = 14},
	fear2 = Position{x = 33719, y = 31505, z = 14},
	fear3 = Position{x = 33718, y = 31508, z = 14},
	fear4 = Position{x = 33707, y = 31499, z = 14},
	fear5 = Position{x = 33708, y = 31510, z = 14},
	
	centerRoom = Position{x = 33713, y = 31503, z = 14}, -- Center Room
	exitPosition = Position{x = 33743, y = 31504, z = 14}, -- Exit Position
	newPos = Position{x = 33713, y = 31509, z = 14}, -- Player Position on room
	playerPositions = {
		Position{x = 33739, y = 31506, z = 14},
		Position{x = 33740, y = 31506, z = 14},
		Position{x = 33741, y = 31506, z = 14},
		Position{x = 33742, y = 31506, z = 14},
		Position{x = 33743, y = 31506, z = 14}
	},
	range = 20,
...
local TheMaidenLever = Action()
function TheMaidenLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 then
		if player:getPosition() ~= Position{x = 33739, y = 31506, z = 14} then
			return true
		end

		for x = 33739, 33743 do
			for y = 31506, 31506 do
				local playerTile = Tile(Position(x, y, 14)):getTopCreature()
				if playerTile and playerTile:isPlayer() then
					if playerTile:getStorageValue(12879635552) > os.time() then
		...
		for x = 33739, 33743 do
			for y = 31506, 31506 do
				...
				if playerTile and playerTile:isPlayer() then
					...
					playerTile:setStorageValue(12879635552, os.time() + 20 * 60 * 60) -- 14 days
...
TheMaidenLever:aid(30002)
TheMaidenLever:register()