...
local MaliceLever = Action()
function MaliceLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
MaliceLever:aid(30056)
MaliceLever:register()