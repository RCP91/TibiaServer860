SnowBall_Configurations = {
	...
	Area_Configurations = {
		Area_Arena = {{x = 32233, y = 31468, z = 7}, {x = 32281, y = 31511, z = 7}}, -- Area da arena do jogo, ({Canto Superior Esquerdo}, {Canto Inferior Direito})
		Position_WaitRoom = {x = 32260, y = 31490, z = 6}, -- Posição da sala de espera do jogo
		Position_ExitWaitRoom = {x = 32257, y = 31490, z = 6}, -- Posição do teleport que sairá da sala de espera do jogo
