BOMBERMAN_MINIGAME = {
	...
	tpPos = {x = 32364, y = 32233, z = 7},
	leverRoom = {x = 32544, y = 32223, z = 6},
    ...
    player_tiles = {
        [1] = Position(32543, 32225, 6),
        [2] = Position(32544, 32225, 6),
        [3] = Position(32545, 32225, 6),
        [4] = Position(32546, 32225, 6),
    ...
    maps = {
        [1] = {
            player_death_spec_pos = Position(32545, 32198, 6),
            players_positions = {
                [1] = Position(32538, 32193, 7),
                [2] = Position(32552, 32193, 7),
                [3] = Position(32552, 32203, 7),
                [4] = Position(32538, 32203, 7),
            }
        }
