...
addTravelKeyword('venore', 40, Position(32954, 32022, 6), function(player) if getPlayerStorageValue(cid, Storage.postman.Mission01) == 3 then setPlayerStorageValue(cid, Storage.postman.Mission01, 4) end end)
