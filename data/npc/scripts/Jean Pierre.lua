...
local function playerHasIngredients(cid)
	...
	local table = ingredients[getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish)]
	if table then
		for i = 1, #table do
			local itemCount = getPlayerItemCount(cid, table[i][1], table[i][3] or -1)
	...
	for i = 1, #table do
		doPlayerRemoveItem(cid, unpack(table[i]))
	end
	return true
end
...
local function greetCallback(cid)
	...
	if getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) < 1 then
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "cook") then
		if getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) < 1 then
			selfSay("Well, I'm not a simple cook. I travel the whole Tibian continent for the most artfully seasoned {recipes} and constantly develop new ones.", cid)
	...
	elseif msgcontains(msg, "recipe") or msgcontains(msg, "menu") then
		if talkState[talkUser] == 1 then
			selfSay("You're interested in my recipes? Well. They are not for sale, but if you want to become my {apprentice}, I'll share my knowledge with you.", cid)
			talkState[talkUser] = 2
		end
		if getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 1 then
			if getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 1 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 2 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 3 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 4 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 5 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 6 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 7 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 8 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 9 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 10 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 11 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 12 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 13 then
				selfSay({
			...
			elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish) == 14 then
				selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("You can now cook any dish you want from this list: {Rotworm Stew, Hydra Tongue Salad, Roasted Dragon Wings, Tropical Fried Terrorbird, Banana Chocolate Shake, Veggie Casserole, Filled Jalapeno Peppers, Blessed Steak, Northern Fishburger, Carrot Cake, Coconut Shrimp Bake, Blackjack, Demonic Candy Balls, Sweet Mangonaise Elixir}.", cid)
		end
	elseif msgcontains(msg, "apprentice") then
		if talkState[talkUser] == 2 then
			selfSay("Hmm. You look quite promising. Can't hurt to give it a try, I guess. Would you like to become my apprentice, |PLAYERNAME|?", cid)
			talkState[talkUser] = 3
		end
	elseif msgcontains(msg, "yes") then
		if talkState[talkUser] == 3 then
			selfSay("Fine, young human. Ask me for a {recipe} anytime and I'll teach you what I know.", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart, 1)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 1)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 1)
		elseif talkState[talkUser] == 5 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 2)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 2)
				doPlayerAddItem(cid, 9992, 1)
				talkState[talkUser] = 0
			else
				selfSay("Make sure that you have all the ingredients, with you.", cid)
				talkState[talkUser] = 0
			end
		elseif talkState[talkUser] == 7 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 3)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 3)
		...
		elseif talkState[talkUser] == 9 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 4)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 4)
		...
		elseif talkState[talkUser] == 11 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 5)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 5)
		...
		elseif talkState[talkUser] == 13 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 6)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 6)
		...
		elseif talkState[talkUser] == 15 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 7)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 7)
		...
		elseif talkState[talkUser] == 17 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 8)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 8)
		...
		elseif talkState[talkUser] == 19 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 9)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 9)
		...
		elseif talkState[talkUser] == 21 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 10)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 10)
				doPlayerAddItem(cid, 10001, 1)
				talkState[talkUser] = 0
			else
				selfSay("Make sure that you have all the ingredients, with you.", cid)
				talkState[talkUser] = 0
		...
		elseif talkState[talkUser] == 23 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 11)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 11)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CookbookDoor, 1)
		...
		elseif talkState[talkUser] == 25 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 12)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 13)
		...
		elseif talkState[talkUser] == 27 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 13)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 14)
		...
		elseif talkState[talkUser] == 29 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 14)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 15)
				doPlayerAddItem(cid, 12543, 1)
				talkState[talkUser] = 0
			else
				selfSay("Make sure that you have all the ingredients, with you.", cid)
				talkState[talkUser] = 0
		...
		elseif talkState[talkUser] == 31 then
			if playerHasIngredients(cid) then
				...
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart, 2)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 15)
				setPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestLog, 16)
	...
	elseif msgcontains(msg, "rotworm stew") then
		if talkState[talkUser] == 4 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to cook Rotworm Stew with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 1)
			talkState[talkUser] = 5
		end
	elseif msgcontains(msg, "hydra tongue salad") then
		if talkState[talkUser] == 6 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to prepare a Hydra Tongue Salad with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 2)
			talkState[talkUser] = 7
		end
	elseif msgcontains(msg, "roasted dragon wings") then
		if talkState[talkUser] == 8 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to prepare Roasted Dragon Wings with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 3)
			talkState[talkUser] = 9
		end
	elseif msgcontains(msg, "tropical fried terrorbird") then
		if talkState[talkUser] == 10 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to prepare a Tropical Fried Terrorbird with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 4)
			talkState[talkUser] = 11
		end
	elseif msgcontains(msg, "banana chocolate shake") then
		if talkState[talkUser] == 12 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to make a Banana Chocolate Shake with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 5)
			talkState[talkUser] = 13
		end
	elseif msgcontains(msg, "veggie casserole") then
		if talkState[talkUser] == 14 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to cook a Veggie Casserole with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 6)
			talkState[talkUser] = 15
		end
	elseif msgcontains(msg, "filled jalapeño peppers") then
		if talkState[talkUser] == 16 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to prepare Filled Jalapeño Peppers with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 7)
			talkState[talkUser] = 17
		end
	elseif msgcontains(msg, "blessed steak") then
		if talkState[talkUser] == 18 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to prepare a Blessed Steak with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 8)
			talkState[talkUser] = 19
		end
	elseif msgcontains(msg, "northern fishburger") then
		if talkState[talkUser] == 20 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to make a Northern Fishburger with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 9)
			talkState[talkUser] = 21
		end
	elseif msgcontains(msg, "carrot cake") then
		if talkState[talkUser] == 22 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to bake a Carrot Cake with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 10)
			talkState[talkUser] = 23
		end
	elseif msgcontains(msg, "coconut shrimp bake") then
		if talkState[talkUser] == 24 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to prepare a Coconut Shrimp Bake with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 11)
			talkState[talkUser] = 25
		end
	elseif msgcontains(msg, "blackjack") then
		if talkState[talkUser] == 26 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to cook a Blackjack with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 12)
			talkState[talkUser] = 27
		end
	elseif msgcontains(msg, "demonic candy ball") then
		if talkState[talkUser] == 28 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to make Demonic Candy Balls with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 13)
			talkState[talkUser] = 29
		end
	elseif msgcontains(msg, "sweet mangonaise elixir") then
		if talkState[talkUser] == 30 or getPlayerStorageValue(cid, Storage.HotCuisineQuest.QuestStart) == 2 then
			selfSay("Did you gather all necessary ingredients to mix Sweet Mangonaise Elixir with me?", cid)
			setPlayerStorageValue(cid, Storage.HotCuisineQuest.CurrentDish, 14)
			talkState[talkUser] = 31
		end
	elseif msgcontains(msg, "no") then
		selfSay("No?, come back when you are ready to cook.", cid)
		talkState[talkUser] = 0
	end
	return true
end
