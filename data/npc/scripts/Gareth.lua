...
if player:getStorageValue(Storage.CultsOfTibia.MotA.Mission) < 2 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 2 then
		...
		npcHandler:say({"So the rumours are true. How could this happen? I'll keep the picture at its place until we've got a replacement. Please fo to {Angelo} and ask him if he has a new {picture} for our museum."}, cid)
