...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if(getPlayerStorageValue(cid, 45250) == -1) then			
			setPlayerStorageValue(cid, 45250, 1)
			setPlayerStorageValue(cid, 45251, 0)
		...
		if(getPlayerStorageValue(cid, 45251) >= 10  and getPlayerStorageValue(cid, 45252) == -1) then
	...
	elseif (msgcontains(msg, "torch") and getPlayerStorageValue(cid, 45252) == -1) then
