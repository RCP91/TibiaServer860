...
function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, 'reward') and talkState[talkUser] == 0 and getPlayerStorageValue(cid, 34013) < 1 then
        selfSay({
        ...
        setPlayerStorageValue(cid, 34013, 1)
        talkState[talkUser] = 0
    
    elseif msgcontains(msg, 'fight') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'retirement') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'memoirs') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'hassle') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'worthy') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'weaknesses') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'mists') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'world') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'books') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'invention') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'adapt') and talkState[talkUser] == 0 then
        selfSay({
    ...
    elseif msgcontains(msg, 'finer') and talkState[talkUser] == 0 then
        selfSay({
