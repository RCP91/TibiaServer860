...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 22 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 23)
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission05, 3) --Questlog, Wrath of the Emperor "Mission 05: New in Town"
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission06, 0) --Questlog, Wrath of the Emperor "Mission 06: The Office Job"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 23 and getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission06) == 4 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 24)
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission07, 0) --Questlog, Wrath of the Emperor "Mission 07: A Noble Cause"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 24 and getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission07) == 6 then
			if talkState[talkUser] ~= 1 then
				...
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission08, 1) --Questlog, Wrath of the Emperor "Mission 08: Uninvited Guests"
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 25)
				talkState[talkUser] = 0
			end
		end
	end
