...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "barbarian") then
		if getPlayerStorageValue(cid, Storage.BarbarianTest.Questline) < 1 then
			selfSay("A true barbarian is something special among our people. Everyone who wants to become a barbarian will have to pass the barbarian {test}.", cid)
	...
	elseif msgcontains(msg, "mead") then
		if getPlayerStorageValue(cid, Storage.BarbarianTest.Questline) == 1 then
			selfSay("Do you have some honey with you?", cid)
			talkState[talkUser] = 4
		elseif getPlayerStorageValue(cid, Storage.BarbarianTest.Questline) == 3 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.BarbarianTest.Questline, 4)
			setPlayerStorageValue(cid, Storage.BarbarianTest.Mission02, 1) -- Questlog Barbarian Test Quest Barbarian Test 2: The Bear Hugging
			doPlayerAddItem(cid, 7140, 1)
			talkState[talkUser] = 0
		end
	elseif msgcontains(msg, "hug") then
		if getPlayerStorageValue(cid, Storage.BarbarianTest.Questline) == 5 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.BarbarianTest.Questline, 6)
			setPlayerStorageValue(cid, Storage.BarbarianTest.Mission02, 3) -- Questlog Barbarian Test Quest Barbarian Test 2: The Bear Hugging
			setPlayerStorageValue(cid, Storage.BarbarianTest.Mission03, 1) -- Questlog Barbarian Test Quest Barbarian Test 3: The Mammoth Pushing
			talkState[talkUser] = 0
		end
	elseif msgcontains(msg, "mammoth") then
		if getPlayerStorageValue(cid, Storage.BarbarianTest.Questline) == 7 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.BarbarianTest.Questline, 8)
			setPlayerStorageValue(cid, Storage.BarbarianTest.Mission03, 3) -- Questlog Barbarian Test Quest Barbarian Test 3: The Mammoth Pushing
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif talkState[talkUser] == 3 then
			...
			talkState[talkUser] = 0
			setPlayerStorageValue(cid, Storage.BarbarianTest.Questline, 1)
			setPlayerStorageValue(cid, Storage.BarbarianTest.Mission01, 1) -- Questlog Barbarian Test Quest Barbarian Test 1: Barbarian Booze
		elseif talkState[talkUser] == 4 then
			if doPlayerRemoveItem(cid, 5902, 1) then
				selfSay("Good, for this honeycomb I allow you 20 sips from the mead bucket over there. Talk to me again about barbarian mead if you have passed the test.", cid)
				talkState[talkUser] = 0
				setPlayerStorageValue(cid, Storage.BarbarianTest.Questline, 2)
				setPlayerStorageValue(cid, Storage.BarbarianTest.Mission01, 2) -- Questlog Barbarian Test Quest Barbarian Test 1: Barbarian Booze
				setPlayerStorageValue(cid, Storage.BarbarianTest.MeadTotalSips, 0)
			else
			selfSay("..You don't have honeycomb..", cid)
