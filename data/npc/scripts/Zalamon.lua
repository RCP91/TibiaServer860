...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		if getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) < 1 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 2 then
			selfSay("What newzz do you bring? Did you find any cluezz about zzeir whereaboutzz? ", cid)
			talkState[talkUser] = 3
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 3 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 5 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 6)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission01, 3) --Questlog, Children of the Revolution "Mission 1: Corruption"
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 6 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 7 then
			if getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.SpyBuilding01) == 1 and getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.SpyBuilding02) == 1 and getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.SpyBuilding03) == 1 then
				selfSay({
				...
				setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 8)
				setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission02, 5) --Questlog, Children of the Revolution "Mission 2: Imperial Zzecret Weaponzz"
				talkState[talkUser] = 0
			end
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 8 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 11 then
			selfSay({
			...
			talkState[talkUser] = 0
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 12)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission03, 3) --Questlog, Children of the Revolution "Mission 3: Zee Killing Fieldzz"
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 12 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 17 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 18 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 20 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 21)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission05, 3) --Questlog, Children of the Revolution "Mission 5: Phantom Army"
		...
		elseif getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 21 and getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) < 1 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 1 then
			selfSay("Ah you have returned. I azzume you already found zzome itemzz to build a proper dizzguizze? ", cid)
			talkState[talkUser] = 16
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 6 then
			selfSay({
		...
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 8 then
			selfSay("Zzo... you finished him. Show me hizz head, will you? ", cid)
			talkState[talkUser] = 20
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 9 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 10)
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission04, 1) --Questlog, Wrath of the Emperor "Mission 04: Sacrament of the Snake"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 11 then
			selfSay("You - azzembled zze zzeptre? Hand it out, give it to me, will you? ", cid)
			talkState[talkUser] = 21
		elseif getPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline) == 12 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 13)
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission05, 1) --Questlog, Wrath of the Emperor "Mission 05: New in Town"
			talkState[talkUser] = 0
		-- WRATH OF THE EMPEROR QUEST
		end
	...
	elseif msgcontains(msg, "crate") then
		if talkState[talkUser] == 17 then
			selfSay("Ah I zzee. You are ready for your mizzion and waiting for me to create and mark zze crate? ", cid)
	...
	elseif msgcontains(msg, "symbols") then
		if getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.StrangeSymbols) == 1 then
			selfSay({
	...
	elseif msgcontains(msg, "poison") or msgcontains(msg, "poizzon") then
		if getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline) == 9 then
			selfSay("Zze emperor of zze dragonzz hazz tranzzformed himzzelf into an undead creature to lazzt for all eternity, to cheat deazz. Hizz corruption flowzz to zzozze he bound, and from zzem to zzozze zzey bound, and from zzem into zze land.", cid)
			talkState[talkUser] = 0
		end
	-- CHILDREN OF REVOLUTION QUEST
	elseif msgcontains(msg, "yes") then
		...
		elseif talkState[talkUser] == 2 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 1)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission00, 1) --Questlog, Children of the Revolution "Prove Your Worzz!"
			talkState[talkUser] = 0
		...
		elseif talkState[talkUser] == 4 then
			if doPlayerRemoveItem(cid, 11101, 1) then
				selfSay({
				...
				setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 3)
				setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission00, 2) --Questlog, Children of the Revolution "Prove Your Worzz!"
				talkState[talkUser] = 0
			end
		elseif talkState[talkUser] == 5 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 4)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission01, 1) --Questlog, Children of the Revolution "Mission 1: Corruption"
		...
		elseif talkState[talkUser] == 6 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 7)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission02, 1) --Questlog, Children of the Revolution "Mission 2: Imperial Zzecret Weaponzz"
		...
		elseif talkState[talkUser] == 8 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 9)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission03, 1) --Questlog, Children of the Revolution "Mission 3: Zee Killing Fieldzz"
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 10 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 13)
			if getPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission04) <= 1 then
				setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission04, 1) --Questlog, Children of the Revolution "Mission 4: Zze Way of Zztonezz"
			end
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 11 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.StrangeSymbols, 2)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission04, 3) --Questlog, Children of the Revolution "Mission 4: Zze Way of Zztonezz"
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 12 then
			...
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 18)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission04, 6) --Questlog, Children of the Revolution "Mission 4: Zze Way of Zztonezz"
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 13 then
			selfSay("You did well on your quezzt zzo far. I hope you will reach zze great gate in time. If we are lucky, it will zztill be open. ... Zalamon: If not, it will already be overrun by enemy zzoldierzz. Direct confrontation will be inevitable in zzat cazze, palezzkin. Now clear your mind and approach zze portal.", cid)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Questline, 19)
			setPlayerStorageValue(cid, Storage.ChildrenoftheRevolution.Mission05, 1) --Questlog, Children of the Revolution "Mission 5: Phantom Army"
			talkState[talkUser] = 0
		-- CHILDREN OF REVOLUTION QUEST
		...
		elseif talkState[talkUser] == 15 then
			...
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 1)
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission01, 1) --Questlog, Wrath of the Emperor "Mission 01: Catering the Lions Den"
			talkState[talkUser] = 0
		...
		elseif talkState[talkUser] == 18 then
			if getPlayerItemCount(cid, 8309) >= 3 and getPlayerItemCount(cid, 5901) >= 1 then
				...
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 2)
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission01, 2) --Questlog, Wrath of the Emperor "Mission 01: Catering the Lions Den"
		...
		elseif talkState[talkUser] == 19 then
			...
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 7)
			setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission03, 1) --Questlog, Wrath of the Emperor "Mission 03: The Keeper"
			doPlayerAddItem(cid, 12320, 1)
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 20 then
			if doPlayerRemoveItem(cid, 12323, 1) then
				selfSay("Zzizz izz not hizz head but clearly belonged to zze keeper. I - I am imprezzed. You can go now. Leave me alone for a zzecond. ", cid)
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 9)
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission03, 3) --Questlog, Wrath of the Emperor "Mission 03: The Keeper"
				talkState[talkUser] = 0
			end

		elseif talkState[talkUser] == 21 then
			if doPlayerRemoveItem(cid, 12327, 1) then
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Questline, 12)
				setPlayerStorageValue(cid, Storage.WrathoftheEmperor.Mission04, 3) --Questlog, Wrath of the Emperor "Mission 04: Sacrament of the Snake"
				selfSay("Finally. At lazzt. Zze zzeptre izz - ourzz. Ourzz of courzze. A weapon we should uzze wizzely for our cauzze. I need a zzecond or two. Do you leave me already? ", cid)
				talkState[talkUser] = 0
			end
		-- WRATH OF THE EMPEROR QUEST
		end
