...
local function creatureSayCallback(cid, type, msg)
    ...
    elseif msgcontains(msg, "mission") then
        ...
        elseif getPlayerStorageValue(cid, Storage.ExplorerSociety.TheSpectralDress) == 50 and getPlayerStorageValue(cid, Storage.ExplorerSociety.QuestLine) == 50 then
            ...
            setPlayerStorageValue(cid, Storage.ExplorerSociety.SpectralStone, 2)			--##############################################
        elseif getPlayerStorageValue(cid, Storage.ExplorerSociety.TheSpectralStone) == 51 and getPlayerStorageValue(cid, Storage.ExplorerSociety.QuestLine) == 51 and getPlayerStorageValue(cid, Storage.ExplorerSociety.SpectralStone) == 1 then --##############################################
            ...
            talkState[talkUser] = 0
        elseif getPlayerStorageValue(cid, Storage.ExplorerSociety.TheSpectralStone) == 52  and getPlayerStorageValue(cid, Storage.ExplorerSociety.QuestLine) == 52 and getPlayerStorageValue(cid, Storage.ExplorerSociety.SpectralStone) == 2 then --##############################################
 			selfSay("The reports from Port Hope have already arrived here and our progress is astonishing. We think it is possible to create an astral bridge between our bases. Are you interested to assist us with this?", cid)
    ...
    elseif msgcontains(msg, "giant smithhammer") and getPlayerStorageValue(cid, Storage.ExplorerSociety.giantsmithhammer) < 1 then
