...
local spells = {	
	[5944]={ buy =1, spell = "Soul Steal", name = "Soul Steal", vocations = {1,2,3,4,5,6,7,8}, level = 80, premium = 0, QuestPoints = 150},	
	[10305]={ buy =1, spell = "Purification", name = "Purification", vocations = {1,2,3,4,5,6,7,8}, level = 120, premium = 0, QuestPoints = 110},
...
function creatureSayCallback(cid, type, msg)
    ...
    local function onBuy(cid, item, subType, amount, ignoreCap, inBackpacks)		
        ...
        if doPlayerRemoveMoney(cid, spells[item].buy) == false then
            return false
        end
