...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "first dragon") then
		selfSay("The First Dragon? The first of all of us? The Son of Garsharak? I'm surprised you heard about him. It is such a long time that he wandered Tibia. Yet, there are some {rumours}.", cid)
		talkState[talkUser] = 1
	elseif msgcontains(msg, "rumours") and talkState[talkUser] == 1 then
		talkState[talkUser] = 2
		selfSay("It is told that the First Dragon had four {descendants}, who became the ancestors of the four kinds of dragons we know in Tibia. They perhaps still have knowledge about the First Dragon's whereabouts - if one could find them.", cid)
	elseif msgcontains(msg, "descendants") and talkState[talkUser] == 2 then
		talkState[talkUser] = 3
		selfSay("The names of these four are Tazhadur, Kalyassa, Gelidrazah and Zorvorax. Not only were they the ancestors of all dragons after but also the primal representation of the {draconic incitements}. About whom do you want to learn more?", cid)
	elseif msgcontains(msg, "draconic incitements") and talkState[talkUser] == 3 then
	...
	elseif msgcontains(msg, "find") then
		...
		selfSay("What do you want to do, if you know about these mighty dragons' abodes? Go there and look for a fight?", cid)
	...
	elseif msgcontains(msg, "yes") and talkState[talkUser] == 6 then
		...
		setPlayerStorageValue(cid, Storage.FirstDragon.Start, 1)
	end
	return true
end
