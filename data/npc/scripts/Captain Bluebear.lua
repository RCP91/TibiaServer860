...
keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Edron}, {Svargrond}, {Yalahar}, citys premium account {Roshamuul}, {Oramond} or {krailos}?'})
