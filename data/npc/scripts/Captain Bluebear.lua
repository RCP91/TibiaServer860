...
addTravelKeyword('carlin', 110, Position(32387, 31820, 6), function(player) if getPlayerStorageValue(cid, Storage.postman.Mission01) == 1 then setPlayerStorageValue(cid, Storage.postman.Mission01, 2) end end)
...
addTravelKeyword('yalahar', 200, Position(32816, 31272, 6), nil, function(player) return getPlayerStorageValue(cid, Storage.SearoutesAroundYalahar.Thais) ~= 1 and getPlayerStorageValue(cid, Storage.SearoutesAroundYalahar.TownsCounter) < 5 end)
