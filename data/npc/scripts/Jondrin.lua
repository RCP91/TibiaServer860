...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "necrometer")) then
		...
		if(talkState[talkUser] == 1) and (getPlayerStorageValue(cid, 10050) == 9) then
			selfSay("Indeed I heard you did a good job out there. <sigh> I guess that means I can hand you one of our necrometers. Handle it with care", cid)
		   ...
		   selfSay("You already got the Necrometer.", cid)
		end
	end
