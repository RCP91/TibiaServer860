...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "marlin") then
		if getPlayerItemCount(cid, 7963) > 0 then
			selfSay("WOW! You have a marlin!! I could make a nice decoration for your wall from it. May I have it?", cid)
			talkState[talkUser] = 1
		end
	elseif msgcontains(msg, "yes") and talkState[talkUser] == 1 then
		if doPlayerRemoveItem(cid, 7963, 1) then
			selfSay("Yeah! Now let's see... <fumble fumble> There you go, I hope you like it!", cid)
			doPlayerAddItem(cid, 7964, 1)
		else
			selfSay("You don't have the fish.", cid)
		end
