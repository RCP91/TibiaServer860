...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "inquisitor") then
		selfSay("The churches of the gods entrusted me with the enormous and responsible task to lead the inquisition. I leave the field work to inquisitors who I recruit from fitting people that cross my way.", cid)
	elseif msgcontains(msg, "join") then
		if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) < 1 then
			selfSay("Do you want to join the inquisition?", cid)
			talkState[talkUser] = 2
		end
	elseif msgcontains(msg, "blessing") or msgcontains(msg, "bless") then
		if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 25 then --if quest is done
			selfSay("Do you want to receive the blessing of the inquisition - which means all five available blessings - for " .. totalBlessPrice .. " gold?", cid)
			talkState[talkUser] = 7
		else
			selfSay("You cannot get this blessing unless you have completed The Inquisition Quest.", cid)
			talkState[talkUser] = 0
		end
    elseif msgcontains(msg, "flask") or msgcontains(msg, "special flask") then
        if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) >= 12 then -- give player the ability to purchase the flask.
        selfSay("Do you want to buy the special flask of holy water for " .. flaskCost .. " gold?" , cid)
        talkState[talkUser] = 8
        else 
			selfSay("You do not need this flask right now.", cid)
			talkState[talkUser] = 0
        end		
	elseif msgcontains(msg, "mission") or msgcontains(msg, "report") then
		if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) < 1 then
			selfSay("Do you want to join the inquisition?", cid)
			talkState[talkUser] = 2
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 1 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 2)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission01, 1) -- The Inquisition Questlog- "Mission 1: Interrogation"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 2 then
			selfSay("Your current mission is to investigate the reliability of certain guards. Are you done with that mission?", cid)
			talkState[talkUser] = 3
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 3 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 4)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission02, 1) -- The Inquisition Questlog- "Mission 2: Eclipse"
			doPlayerAddItem(cid, 7494, 1)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 5 then
			if doPlayerRemoveItem(cid, 8702, 1) then
				...
				setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 6)
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission02, 3) -- The Inquisition Questlog- "Mission 2: Eclipse"
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission03, 1) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			else
				selfSay("You need bring me the witches' grimoire.", cid)
			end
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) > 5 and getPlayerStorageValue(cid, Storage.TheInquisition.Questline) < 11 then
			selfSay("Your current mission is to help the vampire hunter Storkus. Are you done with that mission? ", cid)
			talkState[talkUser] = 4
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 11 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 12)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission04, 1) -- The Inquisition Questlog- "Mission 4: The Haunted Ruin"
			doPlayerAddItem(cid, 7494, 1)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 12 or getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 13 then
			selfSay("Your current mission is to exorcise an evil being from a house in Liberty Bay. Are you done with that mission? ", cid)
			talkState[talkUser] = 5
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 14 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 15)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission05, 1) -- The Inquisition Questlog- "Mission 5: Essential Gathering"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 15 then
			if doPlayerRemoveItem(cid, 6500, 20) then
				selfSay({
				...
				setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 16)
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission05, 2) -- The Inquisition Questlog- "Mission 5: Essential Gathering"
			else
				selfSay("You need 20 of them.", cid)
			end
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 17 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 18)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission06, 1) -- The Inquisition Questlog- "Mission 6: The Demon Ungreez"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 19 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 20)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission06, 3) -- The Inquisition Questlog- "Mission 6: The Demon Ungreez"
			doPlayerAddOutfit(cid, 288, 1)
			doPlayerAddOutfit(cid, 289, 1)
			player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 20 then
			selfSay("Destroy the shadow nexus using this vial of holy water and kill all demon lords.", cid)
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 21)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission07, 1) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
			doPlayerAddItem(cid, 7494, 1)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 21 or getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 22 then
			selfSay("Your current mission is to destroy the shadow nexus in the Demon Forge. Are you done with that mission?", cid)
	...
	elseif msgcontains(msg, "yes") then
		if talkState[talkUser] == 2 then
			...
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 1)
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 3 then
			if getPlayerStorageValue(cid, Storage.TheInquisition.WalterGuard) == 1 and getPlayerStorageValue(cid, Storage.TheInquisition.KulagGuard) == 1 and getPlayerStorageValue(cid, Storage.TheInquisition.GrofGuard) == 1 and getPlayerStorageValue(cid, Storage.TheInquisition.MilesGuard) == 1 and getPlayerStorageValue(cid, Storage.TheInquisition.TimGuard) == 1 then
				selfSay({
				...
				setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 3)
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission01, 7) -- The Inquisition Questlog- "Mission 1: Interrogation"
			else
				selfSay("You haven't done your mission yet.", cid)
			end
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 4 then
			if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 10 then
				selfSay("Good, you've returned. Your skill in practical matters seems to be useful. If you're ready for a further mission, just ask. ", cid)
				setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 11)
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission03, 6) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			else
				selfSay("You haven't done your mission with {Storkus} yet.", cid)
			end
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 5 then
			if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 13 then
				selfSay("Well, this was an easy task, but your next mission will be much more challenging. ", cid)
				setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 14)
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission04, 3) -- The Inquisition Questlog- "Mission 4: The Haunted Ruin"
			else
				selfSay("You haven't done your mission with {Storkus} yet.", cid)
			end
			talkState[talkUser] = 0
		elseif talkState[talkUser] == 6 then
			if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 22 then
				...
				setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 23)
				setPlayerStorageValue(cid, Storage.TheInquisition.Mission07, 3) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
				--player:addAchievement('High Inquisitor')
			else
				selfSay("Come back when you have destroyed the shadow nexus.", cid)
			end
			talkState[talkUser] = 0
        elseif talkState[talkUser] == 8 then
            if doPlayerRemoveMoney(cid, flaskCost) then
            selfSay("Here is your new flask!, |PLAYERNAME|.", cid)
            doPlayerAddItem(cid, 7494, 1)     
            else
		...
		elseif talkState[talkUser] == 7 then
			if player:getBlessings() == 5 then
				selfSay("You already have been blessed!", cid)
			elseif doPlayerRemoveMoney(cid, totalBlessPrice) then
				selfSay("You have been blessed by all of five gods!, |PLAYERNAME|.", cid)
				for b = 1, 5 do
	...
	elseif msgcontains(msg, "outfit") then
		if getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 16 then
			selfSay("Here is your demon hunter outfit. You deserve it. Unlock more addons by completing more missions.", cid)
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 17)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission05, 3) -- The Inquisition Questlog- "Mission 5: Essential Gathering"
			player:addOutfit(288, 0)
			player:addOutfit(289, 0)
			player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheInquisition.Questline) == 23 then
			selfSay("Here is the final addon for your demon hunter outfit. Congratulations!", cid)
			setPlayerStorageValue(cid, Storage.TheInquisition.Questline, 24)
			setPlayerStorageValue(cid, Storage.TheInquisition.Mission07, 4) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
			doPlayerAddOutfit(cid, 288, 1)
			doPlayerAddOutfit(cid, 289, 1)
	...
	elseif msgcontains(msg, 'fardos') then
		selfSay('The priests of Fardos are often mystics who have secluded themselves from worldly matters. Others provide guidance and healing to people in need in the temples.', cid)
		talkState[talkUser] = 0
