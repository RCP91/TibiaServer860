...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "project") and getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) < 1 then
	...
	elseif msgcontains(msg, "short") then
		if talkState[talkUser] == 1 then
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 1)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission01, 1) --Questlog, The New Frontier Quest "Mission 01: New Land"
			talkState[talkUser] = 0
		end
	elseif msgcontains(msg, "mission") then
		if getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) < 1 and talkState[talkUser] == 2 then
			selfSay({
				"Listen, I can handle the organisation down here and my boys will handle the construction of the base fine enough. Actually, all you do down here is to stand in the workers' way. ...",
				"But there might be something for you to do outside the base. We need to learn more about the land up there. Take the lift and do some exploring. Find a passage leading out of the mountains. ...",
				"Do not explore any further though. You never know whom you might be messing with."
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission01, 1) --Questlog, The New Frontier Quest "Mission 01: New Land"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 2 then
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 3)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission01, 3) --Questlog, The New Frontier Quest "Mission 01: New Land"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 3 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 4)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission02, 1) --Questlog, The New Frontier Quest "Mission 02: From Kazordoon With Love"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 7 then
			selfSay("That's good news for sure. It will give our operation a new impulse. However, only if there is not some unexpected trouble ahead. Well, we'll talk about that when we discuss your next {mission}.", cid)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 8)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 8 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 9)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission03, 1) --Questlog, The New Frontier Quest "Mission 03: Strangers in the Night"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 10 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 11)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission03, 3) --Questlog, The New Frontier Quest "Mission 03: Strangers in the Night"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 11 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 12)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission04, 1) --Questlog, The New Frontier Quest "Mission 04: The Mine Is Mine"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 13 then
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 14)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 14 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 15)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission05, 1) --Questlog, The New Frontier Quest "Mission 05: Getting Things Busy"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 15 then
			if getPlayerStorageValue(cid, Storage.TheNewFrontier.BribeKing) == 1 and getPlayerStorageValue(cid, Storage.TheNewFrontier.BribeLeeland) == 1 and getPlayerStorageValue(cid, Storage.TheNewFrontier.BribeExplorerSociety) == 1 and getPlayerStorageValue(cid, Storage.TheNewFrontier.BribeWydrin) == 1 and getPlayerStorageValue(cid, Storage.TheNewFrontier.BribeTelas) == 1 and getPlayerStorageValue(cid, Storage.TheNewFrontier.BribeHumgolf) == 1 then
				...
				setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 16)
				talkState[talkUser] = 0
			end
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 16 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 17)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission06, 1) --Questlog, The New Frontier Quest "Mission 06: Days Of Doom"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 20 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 21)
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 21 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 22)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission07, 1) --Questlog, The New Frontier Quest "Mission 07: Messengers Of Peace"
			talkState[talkUser] = 0
		elseif getPlayerStorageValue(cid, Storage.TheNewFrontier.Questline) == 27 then
			selfSay({
			...
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Questline, 28)
			setPlayerStorageValue(cid, Storage.TheNewFrontier.Mission10, 1) --Questlog, The New Frontier Quest "Mission 10: New Horizons"
			talkState[talkUser] = 0
		end
	end
	return true
