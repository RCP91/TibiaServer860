...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "chalice") and getPlayerStorageValue(cid, Storage.ForgottenKnowledge.Chalice) == 1 then
		selfSay({
	...
	if msgcontains(msg, "daughter") and talkState[talkUser] == 1 then
		selfSay({
	...
	if msgcontains(msg, "story") and talkState[talkUser] == 2 then
		selfSay({
	...
	if msgcontains(msg, "disguised") and talkState[talkUser] == 3 then
		selfSay({
	...
	if msgcontains(msg, "thirsty") and talkState[talkUser] == 4 then
		selfSay({
	...
	if msgcontains(msg, "learned") and talkState[talkUser] == 5 then
		selfSay({
		...
		setPlayerStorageValue(cid, Storage.ForgottenKnowledge.AccessLavaTeleport, 1)
	end
	return true
end
