...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "flou")) then
		if(getPlayerStorageValue(cid, 72328) == 3) then
			selfSay("Lhnjei gouthn naumpi! I know why you are here. I can {explain} everything.", cid)
			talkState[talkUser] = 1
		end
	elseif(msgcontains(msg, "explain")) then
		if(talkState[talkUser] == 1) then
			selfSay("By entering this place, you have earned the right to learn what this is all about. This is a long story. Are you sure you want to hear this, {yes}?", cid)
	...
	elseif(msgcontains(msg, "helmet")) then
		if(talkState[talkUser] == 7) then
			...
			selfSay("Using Deepling craft and various components from down here, I created several spare helmets - just in case this one gets damaged. If you return that small golden anchor to me, you can have one. Will you?", cid)
	...
	elseif(msgcontains(msg, "no")) then
		if(talkState[talkUser] == 3) then
			...
			selfSay("Do you want me to go on?", cid)
	...
	elseif(msgcontains(msg, "yes")) then
		if(talkState[talkUser] == 2) then
			...
			selfSay("Do you have enough, can I stop?", cid)
		...
		elseif(talkState[talkUser] == 4) then
			...
			selfSay("I am now convinced that when they first saw me descending in that suit with the light of the shimmer glower encompassing me, they took me for their God King Qjell. And that's when it all started to make sense. Don't you agree?", cid)
		...
		elseif(talkState[talkUser] == 5) then
			...
			selfSay("And I navigated them out of their miserable lives. Away from their petty interests. I led them to a greater purpose - to form chaos out of order, to bring back the storm to the seas and to make THINGS MOVE. Do you want to hear the rest as well?", cid)
		...
		elseif(talkState[talkUser] == 6) then
			...
			selfSay("You thought you could choose sides? Think again! I nearly led you into the destruction of two species! ME, THE NAVIGATOR! I CONTROL YOU, I OWN YOU! QJELL AFAR GOU JEY!", cid)
			talkState[talkUser] = 7
		elseif(talkState[talkUser] == 8) then
			selfSay("Then take this one. And remember: DO NOT TELL ANYONE ABOUT ME OR ANYTHING YOU HAVE HEARD HERE TODAY.", cid)
