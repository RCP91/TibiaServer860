...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = "My boat is ready to bring you to {Venore}, {Port Hope}, {Liberty Bay}, {Yalahar}, {Ankrahmun} or citys premium account {Gray Island}, {Issavi}, {krailos}, {Roshamuul} or {Oramond}?."})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I am the captain of this ship.'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go {Venore}, {Port Hope}, {Liberty Bay}, {Ankrahmun}, {Yalahar}  or citys premium account {Gray Island}, {Issavi}, {krailos}, {Roshamuul} or {Oramond}?"})
