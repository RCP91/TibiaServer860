...
addTravelKeyword('yalahar', 210, Position(32816, 31272, 6), function(player) return getPlayerStorageValue(cid, Storage.SearoutesAroundYalahar.Darashia) ~= 1 and getPlayerStorageValue(cid, Storage.SearoutesAroundYalahar.TownsCounter) < 5 end)
