...
function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, "ritual") and getPlayerStorageValue(cid, 10050) == 6 then
    ...
    elseif msgcontains(msg, "abandoned sewers") and getPlayerStorageValue(cid, 10050) == 8 then
    ...
    elseif(msgcontains(msg, "notebook")) and getPlayerStorageValue(cid, 10050) == 10 then
        ...
        setPlayerStorageValue(cid, 10050, 12)
