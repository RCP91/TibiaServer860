...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Thais}, {Carlin}, {Ab\'Dendriel}, {Port Hope}, {Edron}, {Venore}, {Darashia}, {Liberty Bay}, {Svargrond}, {Yalahar}, or {Ankrahmun}, citys premium account {Gray Island}, {Roshamuul}, {Issavi}, {Oramond}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Thais}, {Carlin}, {Ab\'Dendriel}, {Port Hope}, {Edron}, {Venore}, {Darashia}, {Liberty Bay}, {Svargrond}, {Yalahar}, or {Ankrahmun}, citys premium account {Gray Island}, {Roshamuul}, {Issavi}, {Oramond}?'})
keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Thais}, {Carlin}, {Ab\'Dendriel}, {Port Hope}, {Edron}, Venore}, {Darashia}, {Liberty Bay}, {Svargrond}, {Yalahar}, or {Ankrahmun}, citys premium account {Gray Island}, {Roshamuul}, {Issavi}, {Oramond}?'})
