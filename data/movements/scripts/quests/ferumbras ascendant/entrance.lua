local config = {
	...
	[2] = {storage = Storage.FerumbrasAscension.Zamulosh},
	[3] = {storage = Storage.FerumbrasAscension.Mazoran},
	[4] = {storage = Storage.FerumbrasAscension.Tarbaz},
	[5] = {storage = Storage.FerumbrasAscension.Plagirath},
	[6] = {storage = Storage.FerumbrasAscension.Shulgrax},
	[7] = {storage = Storage.FerumbrasAscension.Ragiaz},
}
